...
2a. If user is of type Creative then choose expertise from skills list
2b. If user is of type Buyer then list a project
2c. Buyer will be taken to a payment page to add funds to their escrow account. This is automatically updated on the Balanced back-end test marketplace.
3. As a creative you will see a list of projects in your profile for which you have the requisite expertise required of the project.
4. As a creative you can submit a proposal to a project
5. As a buyer you can accept a proposal on one of your projects.
6. When status of proposal changes to accepted, creative receives an SMS to notfiy them
6b. Buyers escrow account will be debited upon acceptance.
7. Both creative and buyer can message eachother through the internal messaging system.
